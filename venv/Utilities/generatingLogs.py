...
logging.basicConfig(filename = '..//logs//test.log',format='%(asctime)s :: %(levelname)s :: %(funcName)s :: %(lineno)d \
...
def main():
    ...
    logger = logging.getLogger(name = "Basic Logs")
    logger.error(" This is Basic Error")
    logger.warning("Sample Warning Message")
    logging.warning("Thanks for the warning")
